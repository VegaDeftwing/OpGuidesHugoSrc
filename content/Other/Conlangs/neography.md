...
This has lead to a lot of conlangs that use the latin alphabet (often with a lot of diacritics) and while that's not inherently a bad thing, it's also unfortunate that doing something with more flair isn't easier.
