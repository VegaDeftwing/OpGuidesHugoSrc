...
A comb filter is a type of electronic filter that produces a series of equally spaced notches or peaks in the frequency response of the filter. This creates a characteristic "comb" pattern in the frequency domain, which is why the filter is called a "comb" filter.
