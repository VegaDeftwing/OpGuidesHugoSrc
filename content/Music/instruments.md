...
Well, most digital instruments give you a huge number of knobs that can be tweaked to get the sound exactly as you want, but that's often not a fair comparison because it would be really hard to get a sound like a guitar if you had to simultaneously play the notes on a MIDI keyboard and turn a huge number of knobs to match the same motion on a real guitar.
