...
{{< hint info >}}
**Reformat:** the bulk storage device in your computer, the hard drive or solid state drive, needs to be formatted before use, this sets up a way for the computer and the drive to agree on a base system for how partitions should be setup, speaking of which:
{{< /hint >}}
